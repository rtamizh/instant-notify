...
exports.create = function  (data,callback) {
	...
	database.query('insert into notifications (id,user_id,is_notified,text,image,notification_link_url,created_at) values (default,"'+data.user_id+'",default,"'+data.text+'","'+data.image+'","'+data.notification_link+'","'+time+'")',function  (err, row) {
		if (err) throw err;
		callback(row);
	});
};
